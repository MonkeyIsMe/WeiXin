        ...
        function(data) {
            ...
            //console.log(data)
                for( var i = 0; i < data.length; i++ ) {
			        ...
			        $trTemp.append("<td style=" + "text-align:center;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;height:30px;"  + ">" +data[i].introductionInfo.substr(30,80) +"</td>");
